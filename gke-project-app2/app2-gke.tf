...
locals {
  envs = {
    dev = {
      ...
      subnetwork                 = "${data.terraform_remote_state.projects.outputs.app2_gke_subnets[0]}" #refer to node subnet
      ip_range_pods              = "${data.terraform_remote_state.projects.outputs.app2_gke_subnets[0][0]}"
      ip_range_services          = "${data.terraform_remote_state.projects.outputs.app2_gke_subnets[0][1]}"
